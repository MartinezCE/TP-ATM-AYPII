...
import Transacciones.ComprarDolares;
import Transacciones.Transaccion;

public class ComprobanteCompraDolares extends Comprobante {
	...
	public String imprimirComprobante(Transaccion transaccion) {
		...
		try {
			...
			+ "," +((ComprarDolares)transaccion).getDestino().getTipo() +","+transaccion.getMonto();
